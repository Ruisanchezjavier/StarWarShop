...
const ProductCard = ({ product }) => {
  const getButtonLink = () => {
    if (product.name === "A New Hope") {
      return `/new_hope`;
    } else if (product.name === "Attack of the Clones") {
      return `/attack_of_the_clones`;
    } else if (product.name === "Battle of Yavin") {
      return `/battle_of_yavin`;
    } 
    else {
      return `/battlefront`;
    }
